...
const Navbar = () => {
  ...
  return (
    <nav className="navbar w-100 bg-body-tertiary" style={{ padding: 0 }}>
      ...
      <form
        style={{ backgroundImage: "url('https://e1.pxfuel.com/desktop-wallpaper/873/692/desktop-wallpaper-interdimensional-rss-the-rick-and-morty-podcast-rick-and-morty-outer-space.jpg')", margin: 0, padding: "10px" }}
